import platform  # 获取计算机类型 进行配置
from os.path import dirname, abspath, join
from environs import Env
from loguru import logger
from mydistributed.myproxpool.utils.parse import parse_redis_connection_string
...
API_PORT = env.int('API_PORT', 5656)
API_THREADED = env.bool('API_THREADED', True)

# flags of enable 是否打开开关
